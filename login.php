        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li><a href="http://localhost/Gaming-Website-1/home.php">Home</a></li>
                      <li><a href="http://localhost/Gaming-Website-1/shop.php">Our Shop</a></li>
                      <li><a href="http://localhost/Gaming-Website-1/product-details.php" class="active">Product Details</a></li>
                      <li><a href="http://localhost/Gaming-Website-1/contact.php">Contact Us</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="main-button">
            <a href="http://localhost/Gaming-Website-1/shop.php">View All</a>
          </div>
        </div>
